...
commonsrc = Split( 'AloneBowlingImpl.cpp AloneBowling.cpp EventReceiverClass.cpp UpdateRender.cpp util.cpp main.cpp SpherePrototype.cpp MeshPrototype.cpp CubePrototype.cpp' )
src = {}

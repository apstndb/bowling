...
commonsrc = Split( 'convert.cpp main.cpp SetupPins.cpp CubePrototype.cpp UpdatePhysics.cpp ClearObjects.cpp CreateBox.cpp MeshPrototype.cpp CreateMesh.cpp CreateShape.cpp SpherePrototype.cpp CreateStartScene.cpp CreateSphere.cpp EventReceiverClass.cpp GetRandInt.cpp QuaternionToEuler.cpp UpdateRender.cpp' )
src = {}

...
ccflags = Split( '-fstrict-overflow -Wstrict-overflow=5 -Wsign-promo -Wstrict-null-sentinel -Wctor-dtor-privacy -Wsign-compare -Wredundant-decls -Wcast-align -Wdisabled-optimization -Wpointer-arith -Winit-self -Wunsafe-loop-optimizations -Wall -Wextra -Wformat=2 -Wcast-qual -Wcast-align -Wwrite-strings -Wconversion -Wpointer-arith -Wno-unused-parameter -std=c++98 -g' )
include = {}

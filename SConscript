...
commonsrc = Split( 'main.cpp UpdatePhysics.cpp ClearObjects.cpp CreateBox.cpp CreateStartScene.cpp CreateSphere.cpp EventReceiverClass.cpp GetRandInt.cpp QuaternionToEuler.cpp UpdateRender.cpp' )
src = {}
